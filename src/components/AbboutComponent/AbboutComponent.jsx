export default function AbboutComponent() {
  return (
    <section
      className="text-white flex flex-col h-screen justify-center xl:px-10 lgg:px-10 md:px-20 px-10 container m-auto"
      id="abbout"
    >
      <div className="relative">
        <div className="grid lg:grid-cols-2 grid-cols-1 grid-rows-1 items-center justify-center w-full gap-2 text-base text-gray-300 tracking-wide relative">
